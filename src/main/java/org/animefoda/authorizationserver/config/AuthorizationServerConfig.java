    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient frontendClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .tokenSettings(TokenSettings.builder()
                        .accessTokenTimeToLive(Duration.ofMinutes(15)) // Access Token de 15 minutos
        ...
        // Este é um serviço que precisa de um token para si mesmo, sem um usuário logado
        RegisteredClient adminApiClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .tokenSettings(TokenSettings.builder()
                        .accessTokenTimeToLive(Duration.ofHours(1)) // Token Server-to-Server de 1 hora
                        .build())
                .build();
